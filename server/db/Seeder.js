import pg from 'pg'
const pool = new pg.Pool({connectionString:"postgres://postgres:password@localhost:5432/animal_shelter_development"})
...
class Seeder {
  static async seed() {
    try {
      ...
      const pets = [
        { name: "Morpheus", imgUrl:"images/morpheus.png", age:187, vaccinationStatus:false, adoptionStory:"Morpheus was found in the Indian Ocean", availableForAdoption:true,petType:fish},
        { name: "Neo", imgUrl:"images/ask-bald-eagle-istock_000017215186large-2.jpg", age:35, vaccinationStatus:false, adoptionStory:"The chosen one was captured in South Florida", availableForAdoption:true,petType:bird},
        { name: "Trinity", imgUrl:"images/images.jpg", age:27, vaccinationStatus:true, adoptionStory:"Trinity was also captured in South Florida", availableForAdoption:true,petType:reptile},
        { name: "Dumbo", imgUrl:"images/baby-elephant-first-bath-3.jpeg", age:1, vaccinationStatus:true, adoptionStory:"Dumbo was saved from the circus", availableForAdoption:true,petType:mammal},
      ]
      ...
      for(let i=0; i < pets.length; i++) {
        ...
        await pool.query(queryString, [pet.name, pet.imgUrl, pet.age, pet.vaccinationStatus, pet.adoptionStory, pet.availableForAdoption, pet.petType.id])
      }
